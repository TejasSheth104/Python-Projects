...
# Image for Home Page Exit Button
...
# Image For Quiz Page Background
...
# Image For Quiz Page Next Button & Finish Button
...
# Image for Last Page Background
...
# Image for Last Page Back To Home Button
...
# Image for Last Page Back To Highscore Button
...
# Image for Last Page Exit Button
...
def score_save(player_name,final_score):
    try:
        fh=open('score.txt','a')
        fh.write(player_name+" --> "+final_score+"\n")
        fh.close()
